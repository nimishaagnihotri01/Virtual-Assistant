    ...
    return(
        <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col p-[20px]">
            ...
            <div className="w-full max-w-[900px] flex justify-center items-center flex-wrap gap-[20px]">
                ...
                <Card image={image6}/>
                <Card image={image7}/>
        <div className={`w-[80px] h-[160px] lg:w-[170px] lg:h-[300px] bg-[#020220] border-2 border-[#0000ff66] rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-blue-950 cursor-pointer hover:border-4 hover:border-white flex items-center justify-center ${selectedImage=="input"?"border-4 border-white shadow-2xl shadow-blue-950":null}`} onClick={() => {
        ...
        <input type="file" accept='image/*' ref={inputImage} hidden onChange={handleImage}/>
            ...
            {selectedImage && <button className="min-w-[150px] h-[60px] mt-[25px] text-black font-semibold cursor-pointer bg-white rounded-full text-[19px]" onClick={()=>navigate("/customize2")}>Next</button>}
